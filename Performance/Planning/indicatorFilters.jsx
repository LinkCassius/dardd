...
class IndicatorFilters extends Component {
  constructor(props) {
    super(props);
  ...
  handleFYChange = (event) => {
    ...
    console.log("this.state.reportingQuarter : ", this.state.reportingQuarter);
    this.props.getFY(event.target.value, this.state.reportingQuarter);
  };
  handleReportingQuarterChange = (event) => {
    this.setState({ reportingQuarter: event.target.value });
    this.props.getFY(this.state.financialYear, event.target.value);
  };
  ...
  componentDidMount() {
    this.props.getFY(this.state.financialYear, this.state.reportingQuarter);
  }
...
export default withStyles(styles)(IndicatorFilters);
