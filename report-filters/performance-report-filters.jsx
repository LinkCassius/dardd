...
import { makeJSDateObject } from "../Performance/helper.js";
...
import "./performance-report-styles.scss";
import {
  ValidatorForm,
  SelectValidator,
...
class PerformanceReportFilters extends Component {
  constructor(props) {
    super(props);
    this.state = {
      responseError: "",
  ...
  render() {
    const { selectedDate, reportingCycle, pickerType, pickerView } = this.state;
...
export default withStyles(styles)(PerformanceReportFilters);
